          ...
          <div class="row align-items-center">
            <div class="col-lg-7 text-center order-lg-2">
              <div class="img-wrap-1 mb-5">
                <img src="{{asset('assets/carrental/images/feature_01.png')}}" alt="Image" class="img-fluid">
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="{{asset('assets/carrental/images/car_6.jpg')}}" alt="Image" class="img-fluid">
              </div>
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="{{asset('assets/carrental/images/person_1.jpg')}}" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="{{asset('assets/carrental/images/person_2.jpg')}}" alt="Image" class="img-fluid mr-3">
                <div class="author-name">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="{{asset('assets/carrental/images/person_3.jpg')}}" alt="Image" class="img-fluid mr-3">
                <div class="author-name">
